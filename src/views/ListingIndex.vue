    ...
    <div class="slider-area">
      <div class="slider-active owl-carousel nav-style-1  owl-dot-none">
        <div
          ...
          style="background-image:url(assets/img/slider/bred11.jpg);"
        >
          <div class="container">
            <div class="row">
              <div class="col-xl-6 col-lg-7 col-md-8 col-12 ml-auto">
                <div class="slider-content-3 slider-animated-1 text-center">
                  ...
                  <div class="slider-btn btn-hover">
                    <a class="animated" style="color:white" href="shop.html">SHOP NOW</a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div
          class="single-slider-2 slider-height-2 d-flex align-items-center bg-img"
          style="background-image:url(assets/img/slider/OFW5.jpg);"
        >
          <div class="container">
            <div class="row">
              <div class="col-xl-6 col-lg-7 col-md-8 col-12 ml-auto">
                <div class="slider-content-3 slider-animated-1 text-center">
                  ...
                  <div class="slider-btn btn-hover">
                    <a class="animated" style="color:black" href="shop.html">SHOP NOW</a>
                  </div>
                </div>
              </div>
            </div>
